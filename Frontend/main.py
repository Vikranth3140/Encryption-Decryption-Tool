...
encryptbrowsebutton = ctk.CTkButton(encrypt_frame, text='Browse', command=Encrypt_browse_key)
encryptbrowsebutton.pack(side=ctk.LEFT)

encryptwithkey = ctk.CTkButton(key_frame, text='Encrypt', command=Encrypt_with_SecretKey)
...
decryptbrowsebutton = ctk.CTkButton(decrypt_frame, text='Browse', command=Decrypt_browse_key)
decryptbrowsebutton.pack(side=ctk.LEFT)

decryptwithkey = ctk.CTkButton(key_frame, text='Decrypt', command=Decrypt_with_SecretKey)
...
encryptbrowsebuttonpass = ctk.CTkButton(encrypt_framepass, text='Browse', command=Encrypt_browse_pass)
encryptbrowsebuttonpass.pack(side=ctk.LEFT)

encryptwithkeypass = ctk.CTkButton(password_frame, text='Encrypt with Password', command=Encrypt_with_Password)
...
decryptbrowsebuttonpass = ctk.CTkButton(decrypt_framepass, text='Browse', command=Decrypt_browse_pass)
decryptbrowsebuttonpass.pack(side=ctk.LEFT)

decryptwithkeypass = ctk.CTkButton(password_frame, text='Decrypt with Password', command=Decrypt_with_Password)
